...
// =========================
// Employee History Screen for CEO/HR viewing specific employee data
// =========================
...
class _EmployeeHistoryScreenState extends State<EmployeeHistoryScreen> {
  ...
  // =========================
  // FETCHING (MODIFIED FOR SPECIFIC EMPLOYEE)
  // =========================

  Future<void> fetchAttendanceHistory() async {
    try {
      // Fetch attendance for the specific employee
  ...
  Future<void> fetchFilteredRecords(String monthName) async {
    try {
      ...
      // Pull everything once for the specific employee, then filter by doc.id month.
      final snapshot = await FirebaseFirestore.instance
          .collection('users')
          .doc(widget.employeeId)
          .collection('attendance')
